    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('Basic', 'Basic'), ('Bronze', 'Bronze'), ('Silver', 'Silver'), ('Gold', 'Gold')], default='Basic', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('Pending', 'Pending'), ('Complete', 'Complete'), ('Failed', 'Failed')], max_length=255)),
